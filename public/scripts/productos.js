...
const pintarCards = data => {
    data.forEach(producto => {
        ...
        templateCard.querySelector('.meta').textContent = `ID: ${producto._id}`
...
const pintarFooter = () => {
    ...
    document.querySelector('.cart-widget-amount').textContent = nCantidad
    templateFooter.querySelector('.bold').textContent = `$ ${nPrecio}`
    ...
    boton.addEventListener('click', () => {
        document.querySelector('.cart-widget-amount').textContent = 0
        carrito = {}
        refreshCar()
        pintarCarrito()
    })
